...
<div class="certificate-wrap">
    ...
    <div class="certificate-content">
        ...
        <p>This is to Certify that <span class="students_name"> <?php echo $this->user->name ?></span>  </p>
    ...
    <div class="signature-wrap">
        ...
        <div class="signature-text">
            ...
            <p> <strong><?php echo get_option('certificate.company_name'); ?></strong> </p>
        </div>
...
<div id="watermark">
    <img src="<?php echo $this->layouts_url ?>/certificate.png" width="100%" height="100%" />
</div>

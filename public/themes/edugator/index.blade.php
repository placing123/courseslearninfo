            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="home-info-box">
                        ...
                        <p class="info-box-desc">like web development,digital marketing,ethical hacking,business analytics, graphic design, Python, and more</p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="home-info-box">
                        ...
                        <p class="info-box-desc">in high-demand fields like IT, AI and cloud engineering where you can earn minimum 12 lakh per annum job easily without having any degree and experience by just taking our any of courses.</p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="home-info-box">
                        ...
                        <p class="info-box-desc">Every course designed by our expert instructor</p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="home-info-box">
                        ...
                        <p class="info-box-desc">Get certified upon completing a course which can helpfull for you to getting your dream job</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    @endif
     ...
     <!--<div class="home-section-wrap home-cta-wrapper py-5 ">
        ...
        <div class="home-course-stats-wrap pb-5 mb-5 text-center">
            @php
             $courses_count = $course->publish()->count();
            
            @endphp
            <div class="container">
                <div class="row">
                    <div class="col-md-3"><h3><strong>{{$courses_count}}+</strong></h3> <h5>Active Courses</h5></div>
                    <div class="col-md-3"> <h3>1500+</h3> <h5>Hours Video</h5></div>
                    <div class="col-md-3"><h3>100+</h3> <h5>Teachers</h5></div>
                    <div class="col-md-3"><h3>5000+</h3> <h5>Students Learning</h5></div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6 home-cta-left-col">
                    ...
                    <div class="home-cta-text-wrapper px-5 text-center">
                        ...
                        <p>Spread your knowledge to millions of students around the world through Websinception teaching platform. You can teach any tech you love from heart.
                        </p>
                        <a href="{{route('courses')}}" class="btn btn-theme-primary">Start Teaching Today</a>
